...
"[project]/app/actions/data:339856 [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$339856__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:339856 [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
function CourseWizard({ teachers }) {
    ...
    const handleSubmit = async ()=>{
        setIsLoading(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$339856__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createCourseWithContent"])({
                ...courseData,
                modules
            });
            if (result.success) {
...
//# sourceMappingURL=_09ca8b1c._.js.map