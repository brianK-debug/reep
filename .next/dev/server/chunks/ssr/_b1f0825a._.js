...
"[project]/app/actions/data:e6b8bf [app-ssr] (ecmascript) <text/javascript>", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$e6b8bf__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__ = __turbopack_context__.i("[project]/app/actions/data:e6b8bf [app-ssr] (ecmascript) <text/javascript>");
"use client";
;
;
;
...
function CourseWizard({ teachers }) {
    ...
    const handleSubmit = async ()=>{
        setIsLoading(true);
        try {
            const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$app$2f$actions$2f$data$3a$e6b8bf__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__$3c$text$2f$javascript$3e$__["createCourseWithContent"])({
                ...courseData,
                modules
            });
            if (result.success) {
...
//# sourceMappingURL=_b1f0825a._.js.map