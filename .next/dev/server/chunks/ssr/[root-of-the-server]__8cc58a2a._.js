...
;
const metadata = {
    title: "REEP - Remote Education Engagement Platform",
    description: "Transform your learning experience with gamification, real-time progress tracking, and an engaging platform designed for remote education.",
    generator: "v0.app",
    icons: {
        icon: [
            {
